  ...
  return (
    <>
      <Layout>
        ...
        <p>NESAR operates according to the standard practices of peer-reviewed scholarly journals. If you submit a contribution for consideration to NESAR, we will collect your name, e-mail address, and institutional affiliation. If the contribution is accepted for publication, we will also ask for your <ExternalLink href="https://viaf.org/">VIAF</ExternalLink> number. With the explicit consent of contributors, this personal information will be published online, including on the webpage and PDF of your article, as well as in the list of authors in the <Link href="/about">about</Link> page. You can opt-out of having your email address published on this website when giving your consent to publish your contribution. If you would like to change or remove any personal information on this website subsequent to the publication of your contribution, please let us know at <ExternalLink href="mailto:nesar@nesarjournal.org">nesar@nesarjournal.org</ExternalLink>.</p>

        <p>Submissions made through NESAR&apos;s Open Journal Systems (OJS) on the <ExternalLink href="https://www.lib.uchicago.edu/">University of Chicago Libraries</ExternalLink> include the above-mentioned personal information. This information may be shared with the <ExternalLink href="https://pkp.sfu.ca/">Public Knowledge Project</ExternalLink>, the developer of OJS, in an anonymized and aggregated form, with appropriate exceptions such as article metrics. The data will not be sold by this journal, the <ExternalLink href="https://www.lib.uchicago.edu/">University of Chicago Libraries</ExternalLink>, or <ExternalLink href="https://pkp.sfu.ca/" >PKP</ExternalLink> nor will it be used for purposes other than those stated here. The authors published in this journal are responsible for the human subject data included in the research reported here.</p>
        ...
        <p>However, this website uses  <ExternalLink href="https://vercel.com/analytics">Vercel analytics</ExternalLink> to collect data about visitors to this website. This third-party service does use cookies and similar technologies to collect the following data from visitors: the page, URL, network speed, browser, device type, device OS, country, web vital, and server-received event time. The recording of data points is anonymous, and Vercel “does not collect or store information that would enable them to reconstruct a browsing session across pages or identify a user.” This data is provided to us in aggregated form that does not reveal your identity. For more information, see Vercel&apos;s <ExternalLink href="https://vercel.com/docs/concepts/analytics/privacy">privacy policy</ExternalLink> for analytics and their <ExternalLink href="https://vercel.com/legal/privacy-policy">privacy notice</ExternalLink>.</p>
        ...
        <p>Our third-party analytics provider responds to <ExternalLink href="https://allaboutdnt.com/">Do Not Track</ExternalLink> signals from your device. You can opt out of all information collected by Vercel analytics by enabling Do Not Track in your web browser.</p>
        ...
        <p>Vercel analytics is compliant with the European Union&apos;s <ExternalLink href="https://gdpr-info.eu/">GDPR</ExternalLink>, which gives residents of the UK and the EEA additional rights over how their personal information is handled. The same regulation covers personal information about contributors. Contributors may exercise their GDPR rights by emailing us at <ExternalLink href="mailto:nesar@nesarjournal.org">nesar@nesarjournal.org</ExternalLink>; visitors to this website must exercise their GDPR rights by contacting Vercel analytics at <ExternalLink href="mailto:privacy@vercel.com">privacy@vercel.com</ExternalLink>.</p>

        <p>If you are a California resident, If you are a California resident, California Civil Code Section 1798.83 permits you to request in writing a list of the categories of personal information relating third parties to which we have disclosed certain categories of personal information during the preceding year for the third parties&apos; direct marketing purposes. Please contact us at <ExternalLink href="mailto:nesar@nesarjournal.org">nesar@nesarjournal.org</ExternalLink> to make such a request.</p>
