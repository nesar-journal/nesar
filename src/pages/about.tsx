  ...
  return (
    <>
      <Layout>
        ...
        <p><i>New Explorations in South Asia Research</i>, or <i>NESAR</i> (<span data-lang="Kan" data-script="Latn">nesaṟ</span> being a Kannada word for “sun”) is an <b>open-access</b> journal publishing original research in South Asian Studies, with a focus on the intellectual and expressive traditions of South India.</p>
